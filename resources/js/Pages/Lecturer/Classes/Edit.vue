...
const props  = defineProps({ class: Object, subjects: Array })
const form   = useForm({ name: props.class.name, subject_ids: [...(props.class.subject_ids ?? [])] })
const submit = () => form.patch(route('lecturer.classes.update', props.class.id))
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header><h2 class="text-xl font-semibold text-gray-800">Edit Class</h2></template>
