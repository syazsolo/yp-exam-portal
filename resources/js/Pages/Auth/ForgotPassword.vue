...
<template>
    <GuestLayout :alt-link="{ href: route('login'), label: 'Back to sign in' }">
        ...
        <header class="mb-7">
            <div class="mb-2.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-ink-mute">Reset password</div>
            <h1 class="font-logo text-[40px] font-light leading-[1.08] tracking-tight text-ink">
                Forgot it? No worry.
            </h1>
            <p class="mt-5 max-w-[380px] text-[13px] font-light leading-[1.75] text-ink-mute">
