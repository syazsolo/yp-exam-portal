...
const fallbackRoles = [
    {
        ...
        label: "Lecturer",
        description:
            "Create exams, review submissions, manage classes and subjects.",
    },
    {
        value: "student",
        label: "Student",
        description:
            "Take exams, track your attempts, stay on top of upcoming assessments.",
    },
];
const roleOptions = computed(() =>
    props.roles.length ? props.roles : fallbackRoles,
);
        ...
        <form @submit.prevent="submit" novalidate>
            ...
            <div class="mb-[18px]">
                <label
                    ...
                    :class="form.errors.name ? 'text-oxblood' : 'text-ink-mute'"
                    >Full name</label
                >
                <div
                    class="flex items-center border-[1.5px] transition"
                    :class="fieldClass('name', form.errors.name)"
                >
                    <input
                        id="name"
                        v-model="form.name"
            ...
            <div class="mb-[18px]">
                ...
                <div
                    class="flex items-center border-[1.5px] transition"
                    :class="fieldClass('email', form.errors.email)"
                >
                    <input
                        id="email"
                        type="email"
            ...
            <div class="mb-[18px]">
                <div
                    ...
                    :class="form.errors.role ? 'text-oxblood' : 'text-ink-mute'"
                >
                    I am a
                </div>
            ...
            <div class="mb-[18px]">
                <label
                    ...
                    class="mb-1.5 block text-[11px] font-semibold uppercase tracking-[0.08em]"
                    :class="
                        form.errors.password ? 'text-oxblood' : 'text-ink-mute'
                    "
                    >Password</label
                >
                <div
                    class="flex items-center border-[1.5px] transition"
                    :class="fieldClass('password', form.errors.password)"
                >
                    <input
                        id="password"
            ...
            <div class="mb-[18px]">
                ...
                <div
                    class="flex items-center border-[1.5px] transition"
                    :class="
                        fieldClass('confirm', form.errors.password_confirmation)
                    "
                >
                    <input
