...
<template>
    <GuestLayout
        :alt-link="{ href: route('register'), label: 'Create an account' }"
    >
        <Head title="Sign in" />
        ...
        <form @submit.prevent="submit" novalidate>
            ...
            <!-- Remember -->
            <label
                class="mb-6 flex cursor-pointer items-center gap-2 text-[12px] text-ink-soft"
            >
                <input
                    type="checkbox"
                    v-model="form.remember"
                    class="h-4 w-4 rounded-none border-[1.5px] border-rule bg-transparent text-ink focus:ring-0 focus:ring-offset-0"
                />
